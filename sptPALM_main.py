        ...
        match prompt_input:       
            ...
            case 1:
                ...
                for key, value in input_parameter.items():
                    print(f"    .{key}: {value}")
                print("\n...'input_parameter' in memory, return to selection menu...")
            case 2:  # analyse_movies_sptPALM,py
                ...
                print("\n...'data' in memory, return to selection menu...")
            case 3:  # combine_analysed_data_sptPALM.py
                ...
                print("\n...Combined data 'comb_data' in memory, return to selection menu...")
            case 4:  # plot_combined_data_sptPALM.py
                ...
                print("\n...Combined data plotted, return to selection menu...")
            case 5:  # MCDDA
                ...
                print("\n...MCDDA performed, return to selection menu...")
