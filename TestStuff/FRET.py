...
plt.axhline(50, color='gray', linestyle='--', linewidth=2)

# Add labels for the lines
for R0 in Foerster_radii:
    x_label = R0 +1.2    # x-value for the label
    y_label = 50  # y-value at 50% FRET efficiency
    plt.text(x_label, y_label + 6, f'$R_0$ {R0} nm', fontsize=16, color='black', ha='center')
