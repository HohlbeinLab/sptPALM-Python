...
def set_parameters_sptPALM_GUI(para = None):
    ...
    fn_combined_movies_entry.grid(row=10, column=1)
    ...
    diff_hist_steps_min_entry.grid(row=2,  column=1)
    ...
    diff_hist_max_entry.grid(row=0, column=3)
    ...
    binwidth_entry.grid(row=1, column=1)
    ...
    tk.Checkbutton(plotting_frame, text="Plot frame number", variable=use_plot_frame_number_var,
                   width = width_text_labels, anchor="w").grid(row=3, column=0, sticky=tk.W)
    ...
    tk.Checkbutton(plotting_frame, text="Show individual cells", variable=use_plot_frame_number_var,
                   width = width_text_labels, anchor="w").grid(row=3, column=2, sticky=tk.W)
    ...
    tk.Checkbutton(plotting_frame, text="Cycle through cells", variable=use_plot_frame_number_var,
                   width = width_text_labels, anchor="w").grid(row=4, column=0, sticky=tk.W)
    ...
    cmap_applied_entry.grid(row=5, column=1, sticky=tk.W)
    ...
    tk.Label(plotting_frame, text="Select plotting option", width = width_text_labels,
             anchor="w").grid(row=5, column=2, sticky=tk.W)
    ...
    plot_norm_histograms_entry = tk.OptionMenu(plotting_frame, plot_norm_histograms_var, 
                                               "probability", "counts")
    plot_norm_histograms_entry.grid(row=5, column=3, sticky=tk.W)
    ...
    scta_plot_cell_window_entry.grid(row=6, column=1)
    ...
    tk.Label(plotting_frame, text="Color-coding [0:D_max)]", width = width_text_labels,
             anchor="w").grid(row=6, column=2, sticky=tk.W)
    scta_vis_rangemax_entry = tk.Entry(plotting_frame, width=width_text_box)
    scta_vis_rangemax_entry.grid(row=6, column=3)
